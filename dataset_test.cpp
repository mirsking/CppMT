...
int main(int argc, char **argv)
{
    ...
    //Init video writer
    CvSize img_size = cvSize(im0.cols, im0.rows);
    string vid_name = "result.avi";
    cv::VideoWriter vid(vid_name, CV_FOURCC('X','V','I','D'), 16, img_size);
